    ...
    private Node createKeyboardGrid() {
        ...
        return gridPane(List.of(
                        ...
                        gridRow(grayButton("7", "sin", "[x]", KeyboardButton.D7),
                                ...
                                grayButton("➖", "√‾", null, KeyboardButton.MINUS),
                                grayButton("➗", "1/x", null, KeyboardButton.DIVISION)),
                        gridRow(grayButton("4", "sin⁻¹", "|x|", KeyboardButton.D4),
                                ...
                                grayButton("✖", "x²", null, KeyboardButton.MULTIPLICATION)),
                        gridRow(grayButton("1", "eˣ", null, KeyboardButton.D1),
                                grayButton("2", "lg", null, KeyboardButton.D2),
